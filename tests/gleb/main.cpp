...
int main(){
    ...
    if(answ==1){
        ...
        // for(int i = 1; i<257; i++){pixel[i] = 0;}
        // for(int i = 1; i<257; i++){
        //     if(i % 16 == 0) {cout << pixel[i] << "  " << endl;}
        //     else            {cout << pixel[i]<< "  ";}
        // }
        cout << "----------------------------------------------" << endl;
        ...
        if(answ==1){
            for(int i = 0; i<1;){
                ...
                cout << "enter the x and y of the elenent that you need to change from 1 to 16" << endl;
                cout << "x = ";
                cin >> x;
                cout << endl;
                cout << "y = ";
                ...
                // for(;;){
                    ...
                    cin >> answ2; // why 0 - 16???
                    // if((answ2 > 16) or (answ2 < 0)){cout << "Error, try again!" << endl;}
                    // else{break;}
                // }
                arr[x][y] = answ2;
                for(int i = 1; i <= 16; ++i){
                ...
                // for(int i = 1; i<257; i++){
                //     int ycord = 0;
                //     if(i % 16 == 0){ycord = ycord + 1;}
                //     if(i==x and ycord==y){pixel[i] = answ2;}
                // }
                // for(int i = 1; i<257; i++){
                //     if(i % 16 == 0) {cout << pixel[i] << "  " << endl;}
                //     else            {cout << pixel[i] << "  ";}
